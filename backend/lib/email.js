...
exports.activate_email = function (user_name, email, acitvate_link) {
	...
	* {
	        ...
	        <tr>
	          <td>
	            ...
	            <table class="btn-primary" cellpadding="0" cellspacing="0" border="0">
	              <tr>
	                <td>
	                  <a href="` + constants.host + `/confirm?email=` + email + `&active_link=` + acitvate_link + `">Verify Your Account</a>
	                </td>
	              </tr>
	            </table>
	            <!-- /button -->
	            ...
	            <p><a href="` + constants.host + `">SOW Team</a></p>
	          </td>
	        </tr>
	      </table>
	      </div>
    ...
    var mailOptions = {
        ...
        subject: 'SOW Account Acitvation', // Subject line
        html: email_data
    };
